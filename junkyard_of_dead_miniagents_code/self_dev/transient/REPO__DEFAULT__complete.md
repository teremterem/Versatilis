...
from miniagents.ext.llm.llm_common import SystemMessage, AssistantMessage
...
PRODUCE_README_SYSTEM_FOOTER = (
    "Please improve the README.md in this framework (improve the explanations, get rid of repetitions, fix code "
    "examples, because some of them are broken)."
)
```
